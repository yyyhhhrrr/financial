...
import com.yhr.quartz.configuration.MyQuartzScheduler;
...
public class VerifyService {
     ...
     * quartz Test
     */
     public void quartzTest(Class <? extends Job> jobClass) throws SchedulerException {
         quartzScheduler.startJob(jobClass);
